<template>
  <div class="section">
    <div class="section--header">
      <h1> PROJECTS AND COMMUNITY INVOLVEMENT </h1>
    </div>
    ...
    <div class="section--item">
      <div class="list--container">
        <ul class="list--education">
          <li>
            <strong>VueJS Components</strong>: Website using VueJS components and NuxtJS framework for creating a professional, online resume.
          </li>
          <li>
